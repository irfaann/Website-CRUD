    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <form 
          method="post" action="<?php echo base_url()."index.php/Welcome/daftar_kegiatan"; ?>">
              <div class="col-lg-12 text-center">
                <div id="success"></div>
                <input id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase" type="submit" value="Daftar">
              </div>
            </div>
          </form>
          </ul>
