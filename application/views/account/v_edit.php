...
<body id="page-top">
  ...
  <header class="masthead">
	...
	<div class="intro-text">
				<div class="intro-lead-in">Edit Akun</div>



<form method="post"action="<?php echo base_url()."index.php/Welcome/update_data"; ?>">
<p>Nama:</p>
<p><input type="text" name="nama" value="<?php echo $nama; ?>"/></p>
