...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="<?php echo base_url()."index.php/Welcome/index"; ?>">Beranda</a></td>
          </li>
        </ul>
      </div>
    </div>
  ...
  <header class="masthead">
	...
	<header class="masthead">
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in">Halaman Log In</div>Akun Anda telah dihapus<br><br>
				<?php
