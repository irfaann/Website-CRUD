...
Hal ini serupa dengan yang terjadi bila anak mengalami benturan fisik seperti tabrakan hebat, atau kecanduan narkotika dan zat adiktif...
        ...
        <div class="col-md-12">
        <hr>
          <h4 class="service-heading"><a href="<?php echo base_url('index.php/Welcome/artikel2'); ?>">Cara Bijak Orangtua yang Mengetahui Anak-nya Kecanduan Pornografi</a></h4>
          <p class="text-muted">Persoalan paling susah dan sering dirasakan oleh orangtua adalah terhadap anaknya terkait konten-konten dewasa yang banyak tersebar di internet.
    Apalagi sosial media juga menyajikan banyak informasi yang tidak bisa kontrol setiap saat.
    Orangtua sering risau dengan konten-konten tersebut...</p>
        </div>
        <div class="col-md-12">
        <hr>
          <h4 class="service-heading"><a href="<?php echo base_url('index.php/Welcome/artikelhiv'); ?>">Bahaya AIDS</a></h4>
          <p class="text-muted">	AIDS ( Acquired Immune Deficiency Syndrome ) adalah kumpulan gejala yang diakibatkan berkurangnya kekebalan tubuh,
	penyebabnya adalah virus yang mudah menular dan merusak sel darah putih sebagai pembawa kekebalan tubuh. 
...</p>
        </div>
        <div class="col-md-12">
        <hr>
          <h4 class="service-heading"><a href="<?php echo base_url('index.php/Welcome/artikelll'); ?>">Brantas Konten Pornografi!</a></h4>
          <p class="text-muted">Kementerian Komunikasi dan Informatika (Kemenkominfo) kembali mengingatkan dan mengajak masyarakat di
