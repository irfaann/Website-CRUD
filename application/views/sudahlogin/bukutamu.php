  ...
  <section class="page-section" id="contact">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
        <div class="texttabel">
        <table style ="background-color: white; text-color:white;">
        <tbody>
        <tr>
            
        </tr>
        <?php foreach ($data as $buku_tamu) { ?>
            <tr>
            
                <?php echo "<i>username</i> : ".$buku_tamu['username']; ?>
                <br><?php echo $buku_tamu['komentar'];?>
                <hr color='white'>
