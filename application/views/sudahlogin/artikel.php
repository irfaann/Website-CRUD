    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1 class="section-heading text-uppercase">Dampak Pornografi Terhadap Kesehatan Mental </h1>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/8.jpg'); ?>" alt="">
          </a>1 
        </div>
      <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="portfolio-hover">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/6.jpg'); ?>" alt="">
          </a>
        </div>
      <div class="col-md-4 col-sm-6 portfolio-item">
           <div class="portfolio-hover">
