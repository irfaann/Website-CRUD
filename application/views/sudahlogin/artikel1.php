    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1 class="section-heading text-uppercase">Mendeteksi Anak Kecanduan Pornografi</h1>
        </div>
        <div class="col-lg-12 text"><br><br>
  <h3 class="section-subheading text-muted">Tanda-tanda anak atau remaja yang mengalami kecanduan pornografi tidak sepenuhnya kasat mata. Para orang tua wajib mewaspadai tanda-tanda tersebut supaya dapat segera dilakukan penanganan dan pencegahan.
   ...
   <br>
   <br>
   Artikel ini telah tayang di Kompas.com dengan judul "Mendeteksi Anak Kecanduan Pornografi", https://megapolitan.kompas.com/read/2010/10/01/16220239/mendeteksi.anak.kecanduan.pornografi.  
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/9.jpg'); ?>" alt="">
          </a>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="portfolio-hover">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/3.jpg'); ?>" height="300" width="700" alt="">
          </a>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
            <div class="portfolio-hover">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/img/5.jpg'); ?>" height="300" width="300" alt="">
          </a>
        </div>
  </section>
</h3>
