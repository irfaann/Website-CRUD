...
class Simple_login {
	...
	*/
	...
	public function ambil_id($komentar, $username){
		//$username = $this->session->userdata('username'); 

		//$row  = ('SELECT nama FROM users where username = "'.$username.'"');
		//$admin     = $row->row();
		//$row = $this->CI->db->query('UPDATE users SET komentar = [$komentar] where username="'$username'"');
